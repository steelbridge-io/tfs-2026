 ...
 * @return void
 */
function the_fly_shop_2025_woocommerce_setup() {
	add_theme_support(
		'woocommerce',
		array(
...
add_action( 'after_setup_theme', 'the_fly_shop_2025_woocommerce_setup' );
 ...
 */
function the_fly_shop_2025_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'the_fly_shop_2025_woocommerce_active_body_class' );
 ...
 */
function the_fly_shop_2025_woocommerce_related_products_args( $args ) {
	$defaults = array(
		'posts_per_page' => 3,
		'columns'        => 3,
	);
...
add_filter( 'woocommerce_output_related_products_args', 'the_fly_shop_2025_woocommerce_related_products_args' );
...
if ( ! function_exists( 'the_fly_shop_2025_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
if ( ! function_exists( 'the_fly_shop_2025_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
if ( ! function_exists( 'the_fly_shop_2025_woocommerce_cart_link_fragment' ) ) {
	/**
	 * Cart Fragments.
	 *
	 ...
	 */
	function the_fly_shop_2025_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		the_fly_shop_2025_woocommerce_cart_link();
		$fragments['a.cart-contents'] = ob_get_clean();

		return $fragments;
	}
}
add_filter( 'woocommerce_add_to_cart_fragments', 'the_fly_shop_2025_woocommerce_cart_link_fragment' );

if ( ! function_exists( 'the_fly_shop_2025_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
...
if ( ! function_exists( 'the_fly_shop_2025_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function the_fly_shop_2025_woocommerce_header_cart() {
		if ( is_cart() ) {
