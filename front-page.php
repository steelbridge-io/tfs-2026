...
<?php if (!empty($carousel_items)) : ?>
        ...
        <div class="carousel-inner">
            <?php foreach ($carousel_items as $index => $item) : ?>
                <div class="carousel-item <?php echo ($index === 0) ? 'active initial' : ''; ?>">
                    <img class="img-fluid object-fit-cover d-block w-100" src="<?php echo esc_url($item['image']); ?>"
    ...
    <?php if ($has_tablet_carousel) : ?>
        <div id="carouselExampleFadeTablet" class="carousel slide carousel-fade d-none d-md-block d-lg-none"
            ...
            <div class="carousel-inner">
                <?php foreach ($carousel_items as $index => $item) : ?>
                    ...
                    ?>
                    <div class="carousel-item <?php echo ($index === 0) ? 'active initial' : ''; ?>">
                        <img class="img-fluid object-fit-cover d-block w-100" src="<?php echo esc_url($tablet_img); ?>"
                             alt="<?php echo esc_attr($item['title']); ?>">
            ...
            <?php if (count($carousel_items) > 1) : ?>
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFadeTablet"
                        data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFadeTablet"
                        data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
    ...
    <?php else : ?>
        <!-- Tablet Fallback -->
        <div id="carouselExampleFadeTabletFallback" class="carousel slide carousel-fade d-none d-md-block d-lg-none"
             data-bs-ride="carousel" data-bs-interval="8000">
            <div class="carousel-inner">
                <?php foreach ($carousel_items as $index => $item) : ?>
                    <div class="carousel-item <?php echo ($index === 0) ? 'active initial' : ''; ?>">
                        <img class="img-fluid object-fit-cover d-block w-100"
            ...
            <?php if (count($carousel_items) > 1) : ?>
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFadeTabletFallback"
                        data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFadeTabletFallback"
                        data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
    ...
    <?php if ($has_mobile_carousel) : ?>
        <div id="carouselExampleFadeMobile" class="carousel slide carousel-fade d-block d-md-none"
             data-bs-ride="carousel" data-bs-interval="8000">
            <div class="carousel-inner">
                <?php foreach ($carousel_items as $index => $item) : ?>
                    <?php
                    ...
                    ?>
                    <div class="carousel-item <?php echo ($index === 0) ? 'active initial' : ''; ?>">
                        <img class="img-fluid object-fit-cover d-block w-100" src="<?php echo esc_url($mobile_img); ?>"
                             alt="<?php echo esc_attr($item['title']); ?>">
    ...
    <?php else : ?>
        ...
        <div id="carouselExampleFadeFallback" class="carousel slide carousel-fade d-block d-md-none"
             data-bs-ride="carousel" data-bs-interval="8000">
            <div class="carousel-inner">
                <?php foreach ($carousel_items as $index => $item) : ?>
                    <div class="carousel-item <?php echo ($index === 0) ? 'active initial' : ''; ?>">
            ...
            <?php if (count($carousel_items) > 1) : ?>
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFadeFallback"
                        data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFadeFallback"
                        data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
    ...
    <div class="wave-section">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
            <path fill="#ffffff"
                  d="M0,64L60,80C120,96,240,128,360,170.7C480,213,600,267,720,245.3C840,224,960,128,1080,85.3C1200,43,1320,53,1380,58.7L1440,64L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
        </svg>
    </div>
<?php else : ?>
...
if (!empty($cards)) :
    ?>
    <section id="card-grid-container" class="content-section mt-4 mb-5" data-aos="fade-up" data-aos-delay="1000"
             data-aos-once="true">
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    foreach ($cards as $index => $card) :
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 card-feature <?php echo esc_attr($style_class); ?>"
                             data-aos="" data-aos-offset="200" data-aos-duration="1000">
                            <div class="card-container">
                                <img src="<?php echo esc_url($card['image']); ?>"
                                     alt="<?php echo esc_attr($card['image_alt']); ?>" class="card-img">
                                ...
                                <div class="card-hover-content">
                                    ...
                                    <?php if (!empty($card['button_url'])) : ?>
                                        <a href="<?php echo esc_url($card['button_url']); ?>"
                                           class="btn btn-tfs btn-sm"><?php echo esc_html($card['button_text']); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item-custom">
                            <div class="custom-card">
                                <img src="<?php echo esc_url($item['image']); ?>"
                                     alt="<?php echo esc_attr($item['title']); ?>" class="custom-card-image"/>
                                <div class="custom-card-body">
                                    ...
                                    <a href="<?php echo esc_url($item['url']); ?>" class="custom-card-link">View
                                        Product</a>
                                </div>
                            </div>
                        </div>
