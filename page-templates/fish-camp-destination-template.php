<?php
/**
 * Template Name: Fish Camp Destination Template v1
...
<?php endif; ?>
                        ...
                        if (!empty($feature_fc2_readmore_textarea)) :?>
                            ...
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOnedates" aria-expanded="false"
                                        aria-controls="collapseOnedates">
                ...
                <div class="accordion" id="accordionfive">
                    <div class="accordion-item">
                        ...
                        if (!empty($feature_fcfive_readmore_textarea)) :?>
                            ...
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOnefive" aria-expanded="false"
    ...
    <div class="additional-img modal fade fishcamp-modal" tabindex="-1" aria-labelledby="fishCampModalLabel"
         aria-hidden="true">
