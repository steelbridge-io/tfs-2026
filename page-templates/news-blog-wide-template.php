                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 read-more-posts-cont">
                                                <a href="<?php echo $news_template_read_more_cat_one; ?>"
                                                   title="Read More Posts">
                                                    <div class="readmore-bg-img"
                                                         style="background-image: url('<?php echo $read_more_image_one; ?>');">
                                                        <button class="tfs-btn tfs-btn-dark btn btn-center"
                                                                type="button"><h4>Read More Articles Here</h4></button>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="well">
                                ...
                                <?php if ($news_template_read_more_cat_two !== $default) : ?>
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 read-more-posts-cont">
                                                <a href="<?php echo $news_template_read_more_cat_two; ?>"
                                                   title="Read More Posts">
                                                    <div class="readmore-bg-img"
                                                         style="background-image: url('<?php echo $read_more_image_two; ?>');">
                                                        <button class="tfs-btn tfs-btn-dark btn btn-center"
                                                                type="button"><h4>Read More Articles Here</h4></button>
                                                    </div>
                                                </a>
                            ...
                            <div class="well">
                                ...
                                <?php if ($news_template_read_more_cat_three !== $default) : ?>
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 read-more-posts-cont">
                                                <a href="<?php echo $news_template_read_more_cat_three; ?>"
                                                   title="Read More Posts">
                                                    <div class="readmore-bg-img"
                                                         style="background-image: url('<?php echo $read_more_image_three; ?>');">
                                                        <button class="tfs-btn tfs-btn-dark btn btn-center"
                                                                type="button"><h4>Read More Articles Here</h4></button>
                                                    </div>
                                                </a>
                            ...
                            <div class="well">
                                ...
                                <?php if ($news_template_read_more_cat_four !== $default) : ?>
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 read-more-posts-cont">
                                                <a href="<?php echo $news_template_read_more_cat_four; ?>"
                                                   title="Read More Posts">
                                                    <div class="readmore-bg-img"
                                                         style="background-image: url('<?php echo $read_more_image_four; ?>');">
                                                        <button class="tfs-btn tfs-btn-dark btn btn-center"
                                                                type="button"><h4>Read More Articles Here</h4></button>
                                                    </div>
                                                </a>
                            ...
                            <div class="well">
                                ...
                                <?php if ($news_template_read_more_cat_five !== $default) : ?>
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 read-more-posts-cont">
                                                <a href="<?php echo $news_template_read_more_cat_five; ?>"
                                                   title="Read More Posts">
                                                    <div class="readmore-bg-img"
                                                         style="background-image: url('<?php echo $read_more_image_four; ?>');">
                                                        <button class="tfs-btn tfs-btn-dark btn btn-center"
                                                                type="button"><h4>Read More Reports Here</h4></button>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
