    ...
    <section id="featured-stream-reports" class="featured-content">
        ...
        <div class="container text-center mt-5">
            ...
            <div id="featured-reports-container" class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    <a data-bs-toggle="modal" href="#stream-report.php" data-bs-target=".featuredreport1" role="button"
                       class="thumbnail featuredreport clicky"><img src="<?php echo $featured1_image; ?>"
                                                                    alt="Northern California - The Fly Shop - Stream Report"></a>
                </div>

                <div class="col-xs-6 col-md-3">
                    <a data-bs-toggle="modal" data-bs-target=".featuredreport2" role="button"
                       class="thumbnail featuredreport"><img src="<?php echo $featured2_image; ?>"
                                                             alt="Northern California - The Fly Shop - Stream Report"></a>
                </div>

                <div class="col-xs-6 col-md-3">
                    <a data-bs-toggle="modal" data-bs-target=".featuredreport3" role="button"
                       class="thumbnail featuredreport"><img src="<?php echo $featured3_image; ?>"
                                                             alt="Northern California - The Fly Shop - Stream Report"></a>
                </div>

                <div class="col-xs-6 col-md-3">
                    <a data-bs-toggle="modal" data-bs-target=".featuredreport4" role="button"
                       class="thumbnail featuredreport"><img src="<?php echo $featured4_image; ?>"
                                                             alt="Northern California - The Fly Shop - Stream Report"></a>
                </div>
        ...
        <div id="regional-reports" class="container d-none d-md-block">
            ...
            <div id="report-tab-selector-rivers" class="d-flex align-items-start report-container">
                ...
                <div class="nav flex-column nav-pills me-3 report-button" id="v-pills-tab-rivers" role="tablist"
                     aria-orientation="vertical">

                    <button class="btn btn-tfs active" id="fall-river-tab" data-bs-toggle="pill"
                            data-bs-target="#fall-river-report" type="button" role="tab"
                            aria-controls="fall-river-report" aria-selected="true">Fall River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="hat-creek-tab" data-bs-toggle="pill"
                            data-bs-target="#hat-creek-report" type="button" role="tab" aria-controls="hat-creek-report"
                            aria-selected="false">Hat Creek:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="klamath-river-tab" data-bs-toggle="pill"
                            data-bs-target="#klamath-river-report" type="button" role="tab"
                            aria-controls="klamath-river-report" aria-selected="false">Klamath River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="lower-sac-tab" data-bs-toggle="pill"
                            data-bs-target="#lower-sac-report" type="button" role="tab" aria-controls="lower-sac-report"
                            aria-selected="false">Lower Sacramento River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="mccloud-river-tab" data-bs-toggle="pill"
                            data-bs-target="#mccloud-river-report" type="button" role="tab"
                            aria-controls="mccloud-river-report" aria-selected="false">McCloud River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="pit-river-tab" data-bs-toggle="pill"
                            data-bs-target="#pit-river-report" type="button" role="tab" aria-controls="pit-river-report"
                            aria-selected="false">Pit River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="trinity-river-tab" data-bs-toggle="pill"
                            data-bs-target="#trinity-river-report" type="button" role="tab"
                            aria-controls="trinity-river-report" aria-selected="false">Trinity River:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="upper-sac-tab" data-bs-toggle="pill"
                            data-bs-target="#upper-sac-report" type="button" role="tab" aria-controls="upper-sac-report"
                            aria-selected="false">Upper Sacramento River:&nbsp;
                ...
                <div class="tab-content report-content " id="v-pills-tabContent-rivers">
                    ...
                    <div class="tab-pane fade show active" id="fall-river-report" role="tabpanel"
                         aria-labelledby="fall-river-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="hat-creek-report" role="tabpanel" aria-labelledby="hat-creek-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="klamath-river-report" role="tabpanel"
                         aria-labelledby="klamath-river-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="lower-sac-report" role="tabpanel" aria-labelledby="lower-sac-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="mccloud-river-report" role="tabpanel"
                         aria-labelledby="mccloud-river-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="pit-river-report" role="tabpanel" aria-labelledby="pit-river-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="trinity-river-report" role="tabpanel"
                         aria-labelledby="trinity-river-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="upper-sac-report" role="tabpanel" aria-labelledby="upper-sac-tab"
                         tabindex="0">
            ...
            <div id="report-tab-selector-still-waters" class="d-flex align-items-start report-container">
                ...
                <div class="nav flex-column nav-pills me-3 report-button" id="v-pills-tab-still-waters" role="tablist"
                     aria-orientation="vertical">

                    <button class="btn btn-tfs active" id="baum-lake-tab" data-bs-toggle="pill"
                            data-bs-target="#baum-lake-report" type="button" role="tab" aria-controls="baum-lake-report"
                            aria-selected="true">Baum Lake:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="iron-cyn-tab" data-bs-toggle="pill"
                            data-bs-target="#iron-cyn-report" type="button" role="tab" aria-controls="iron-cyn-report"
                            aria-selected="false">Iron Canyon Reservoir:&nbsp;
                    ...
                    <?php //echo $keswickres_closed_checkbox; ?><!--">-->
                    <?php //echo $keswickres_closed_message; ?><!--</span>-->
                    <?php //else: ?>
                    <!--                         <span class="label label-default-->
                    <?php //echo $keswickres_checkbox_poor; ?><!--">Poor</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $keswickres_checkbox_fair;  ?><!--">Fair</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $keswickres_checkbox_fairgood; ?><!--">Fair to Good</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $keswickres_checkbox_good; ?><!--">Good</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $keswickres_checkbox_great; ?><!--">Great</span>-->
                    <?php //endif; ?>
                    <!--                    </button>-->
                    <button class="btn btn-tfs" id="lake-shasta-tab" data-bs-toggle="pill"
                            data-bs-target="#lake-shasta-report" type="button" role="tab"
                            aria-controls="lake-shasta-report" aria-selected="false">Lake Shasta:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="lewiston-lake-tab" data-bs-toggle="pill"
                            data-bs-target="#lewiston-lake-report" type="button" role="tab"
                            aria-controls="lewiston-lake-report" aria-selected="false">Lewiston Lake:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="manzanita-lake-tab" data-bs-toggle="pill"
                            data-bs-target="#manzanita-lake-report" type="button" role="tab"
                            aria-controls="manzanita-lake-report" aria-selected="false">Manzanita Lake:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="mccloud-res-tab" data-bs-toggle="pill"
                            data-bs-target="#mccloud-res-report" type="button" role="tab"
                            aria-controls="mccloud-res-report" aria-selected="false">McCloud Reservoir:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="pyramid-lake-tab" data-bs-toggle="pill"
                            data-bs-target="#pyramid-lake-report" type="button" role="tab"
                            aria-controls="pyramid-lake-report" aria-selected="false">Pyramid Lake:&nbsp;
                ...
                <div class="tab-content report-content" id="v-pills-tabContent-still-waters">
                    ...
                    <div class="tab-pane fade show active" id="baum-lake-report" role="tabpanel"
                         aria-labelledby="baum-lake-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="iron-cyn-report" role="tabpanel" aria-labelledby="iron-cyn-tab"
                         tabindex="0">
                    ...
                    <!--                        <h4>Keswick Reservoir - Updated:&nbsp;-->
                    <?php //echo $keswickres_updated; ?><!--</h4>-->
                    <!--                        <p><b>Fishing conditions:</b>&nbsp;-->
                    <?php //if(get_post_meta(get_the_ID(), 'keswickres-closed-checkbox', true) == '-danger') :?>
                    <!--                             <span class="label label-default-->
                    <?php //echo $keswickres_closed_checkbox; ?><!--">-->
                    ...
                    <?php //endif; ?>
                    <!--                        </p>-->
                    <!--                        <div class="report"><b>Report:</b>&nbsp;-->
                    <?php //echo $keswickres_report; ?><!--</div>-->
                    <!--                        <div><b>Hot Flies:</b>-->
                    <?php //echo $keswickres_hot_flies; ?><!--</div>-->
                    <!--                    </div>-->
                    <div class="tab-pane fade" id="lake-shasta-report" role="tabpanel" aria-labelledby="lake-shasta-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="lewiston-lake-report" role="tabpanel"
                         aria-labelledby="lewiston-lake-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="manzanita-lake-report" role="tabpanel"
                         aria-labelledby="manzanita-lake-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="mccloud-res-report" role="tabpanel" aria-labelledby="mccloud-res-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="pyramid-lake-report" role="tabpanel"
                         aria-labelledby="pyramid-lake-tab" tabindex="0">
            ...
            <div id="report-tab-selector-private-waters" class="d-flex align-items-start report-container">
                ...
                <div class="nav flex-column nav-pills me-3 report-button" id="v-pills-tab-private-waters" role="tablist"
                     aria-orientation="vertical">

                    <button class="btn btn-tfs active" id="antelope-creek-tab" data-bs-toggle="pill"
                            data-bs-target="#antelope-creek-report" type="button" role="tab"
                            aria-controls="antelope-creek-report" aria-selected="true">Antelope Creek:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="battle-creek-tab" data-bs-toggle="pill"
                            data-bs-target="#battle-creek-report" type="button" role="tab"
                            aria-controls="battle-creek-report" aria-selected="false">Battle Creek:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="bollibokka-tab" data-bs-toggle="pill"
                            data-bs-target="#bollibokka-report" type="button" role="tab"
                            aria-controls="bollibokka-report" aria-selected="false">Bollibokka:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="circle7-tab" data-bs-toggle="pill" data-bs-target="#circle7-report"
                            type="button" role="tab" aria-controls="circle7-report" aria-selected="false">Circle 7 Guest
                        Ranch:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="clear-creek-tab" data-bs-toggle="pill"
                            data-bs-target="#clear-creek-report" type="button" role="tab"
                            aria-controls="clear-creek-report" aria-selected="false">Clear Creek Ranch:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="gold-river-tab" data-bs-toggle="pill"
                            data-bs-target="#gold-river-report" type="button" role="tab"
                            aria-controls="gold-river-report" aria-selected="false">Gold River Lodge:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="luk-lake-tab" data-bs-toggle="pill"
                            data-bs-target="#luk-lake-report" type="button" role="tab" aria-controls="luk-lake-report"
                            aria-selected="false">Luk Lake:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="oasis-springs-tab" data-bs-toggle="pill"
                            data-bs-target="#oasis-springs-report" type="button" role="tab"
                            aria-controls="oasis-springs-report" aria-selected="false">Oasis Springs:&nbsp;
                    ...
                    <button class="btn btn-tfs" id="rock-creek-tab" data-bs-toggle="pill"
                            data-bs-target="#rock-creek-report" type="button" role="tab"
                            aria-controls="rock-creek-report" aria-selected="false">Rock Creek Lake:&nbsp;
                    ...
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_closed_checkbox;?><!--">-->
                    <?php //echo $sugarcreek_closed_message;?><!--</span>-->
                    <?php //else: ?>
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_checkbox_poor; ?><!--">Poor</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_checkbox_fair; ?><!--">Fair</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_checkbox_fairgood; ?><!--">Fair to Good</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_checkbox_good; ?><!--">Good</span>-->
                    <!--                         <span class="label label-default-->
                    <?php //echo $sugarcreek_checkbox_great; ?><!--">Great</span>-->
                    <?php //endif; ?>
                    <!--                    </button>-->
                </div>
                ...
                <div class="tab-content report-content" id="v-pills-tabContent-private-waters">
                    ...
                    <div class="tab-pane fade show active" id="antelope-creek-report" role="tabpanel"
                         aria-labelledby="antelope-creek-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="battle-creek-report" role="tabpanel"
                         aria-labelledby="battle-creek-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="bollibokka-report" role="tabpanel" aria-labelledby="bollibokka-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="circle7-report" role="tabpanel" aria-labelledby="circle7-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="clear-creek-report" role="tabpanel" aria-labelledby="clear-creek-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="gold-river-report" role="tabpanel" aria-labelledby="gold-river-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="luk-lake-report" role="tabpanel" aria-labelledby="luk-lake-tab"
                         tabindex="0">
                    ...
                    <div class="tab-pane fade" id="oasis-springs-report" role="tabpanel"
                         aria-labelledby="oasis-springs-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="rock-creek-report" role="tabpanel" aria-labelledby="rock-creek-tab"
                         tabindex="0">
                    ...
                    <!--                        <h4>Sugar Creek Ranch - Updated:&nbsp;-->
                    <?php //echo $sugarcreek_updated; ?><!--</h4>-->
                    <!--                        <p><b>Fishing conditions:</b>&nbsp;-->
                    <?php //if(get_post_meta(get_the_ID(), 'sugarcreek-closed-checkbox', true) == '-danger'):?>
                    <!--                             <span class="label label-default-->
                    <?php //echo $sugarcreek_closed_checkbox;?><!--">-->
                    ...
                    <!--                        </p>-->
                    <!--                        <div class="report"><b>Report:</b>&nbsp;-->
                    <?php //echo $sugarcreek_report; ?><!--</div>-->
                    <!--                        <div><b>Hot Flies:</b>-->
                    <?php //echo $sugarcreek_hot_flies; ?><!--</div>-->
                    <!--                    </div>-->
