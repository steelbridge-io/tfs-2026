                ...
                <div class="row justify-content-center">
                    <div class="subscribe-form">
                        ...
                        <div id="pop-over-fp" class="col-12 no-spam-signup">
                            <p class="text-align-center small-text d-flex justify-content-center align-items-center">Click here to review our subscription policy&nbsp;:&nbsp;<a role="button" class="subscribe-policy-icon" data-bs-toggle="collapse" href="#collapseTraveltemplate" aria-expanded="false"
                                                                                                                                                                                 aria-controls="collapseTraveltemplate"><span class="bi bi-question-circle fs-3"></span></a></p>
                        </div>
                    </div>
                </div>
                <div class="collapse" id="collapseTraveltemplate">
                    <div class="well">
                        <p class="small-text">"We respect your privacy and do not tolerate spam and will never sell, rent, lease or give
                            away your email address to any third party. Nor will we send you unsolicited email. You will
            ...
            <div class="row">
                <div class="newscta" id="news-cta">
                    <div data-aos-duration="1000" data-aos="fade-up" class="news-section">
                        <h3>Latest Estancia Maria Behety Lodge News - The Fly Shop</h3>
                        <?php
