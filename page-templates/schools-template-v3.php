    ...
    <section id="tabbed-destination-content" class="container-fluid mt-5">
        <div class="container">
            ...
            <ul class="nav nav-pills nav-tabs destination-tabs" id="destinationTabs" role="tablist">
                <?php if ($travel_seasons_image !== '') : ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="seasons-tab" data-bs-toggle="tab"
                                data-bs-target="#seasons-pane"
                ...
                if ($feature_6_supplemental_img !== '') : ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="supplemental-tab" data-bs-toggle="tab"
                                data-bs-target="#supplemental-pane"
            ...
            <div class="tab-content destination-tab-content" id="destinationTabContent">
                    ...
                    <?php if ($travel_seasons_image !== '') : ?>
                        <div class="tab-container-wrapper">
                                ...
                                if ($feature_2_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($travel_seasons_image); ?>">
                                            <source src="<?php echo $feature_2_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($travel_seasons_image); ?>"
                            ...
                            <div class="feature-content">
                                ...
                                // NEW MULTI-SEASON CALENDAR (Dual Ranges with overlap handling)
                                if ($monthly_range_checkbox === 'yes'):
                                    $hasActiveSeasons = false;
                                    foreach ($seasons as $s) {
                                        if (!empty($s['start_month']) && !empty($s['end_month']) && (int)$s['start_month'] > 0 && (int)$s['end_month'] > 0) {
                                            ...
                                            <div class="month-display-grid">
                                                ...
                                                for ($month = 1; $month <= 12; $month++):
                                                    ...
                                                    foreach ($periods as $period):
                                                        ...
                                                        // Helper to check if a range covers this month/period
                                                        $matchesRange = function ($startMonth, $endMonth, $startPart, $endPart) use ($month, $period, $periods) {
                                                            ...
                                                            return true; // full months between
                                                        };

                                                        // Consider up to three seasons, each with two ranges
                                                        foreach ([1, 2, 3] as $sn) {
                                                    ...
                                                    if (!empty($season['start_month']) && !empty($season['end_month']) && (int)$season['start_month'] > 0 && (int)$season['end_month'] > 0): ?>
                                                        <div class="legend-item"
                                                            ...
                                                            <div class="legend-color"
                                                                 style="width: 20px; height: 20px; background-color: <?php echo esc_attr($season['color'] ?: '#28a745'); ?>; border: 2px solid #333; border-radius: 3px;"></div>
                                                            <span style="font-weight: 500;">&nbsp;<?php echo esc_html($season['name'] ?: "Season {$seasonNum}"); ?></span>
                                                        </div>
                                                    <?php endif;
                                                    // Range 2 legend only when name_2 is provided
                                                    if (!empty($season['name_2'])): ?>
                                                        <div class="legend-item"
                                                             style="display: flex; align-items: center; gap: 8px; margin-bottom: 5px;">
                                                            <div class="legend-color"
                                                                 style="width: 20px; height: 20px; background-color: <?php echo esc_attr($season['color_2'] ?: ($season['color'] ?: '#28a745')); ?>; border: 2px solid #333; border-radius: 3px;"></div>
                                ...
                                if (!empty($feature_2_seasons_readmore)) : ?>
                                    <button type="button" class="btn destination btn-tfs" data-target="seasonsReadmore">
                                        Read
                                        more...
                                    </button>
                                <?php endif; ?>
                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_3_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_3_getting_to_image); ?>">
                                            <source src="<?php echo $feature_3_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($feature_3_getting_to_image); ?>"
                                         alt="The Fly Shop Travel Image">
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_4_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_4_lodging_img); ?>">
                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_5_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_5_itinerary_img); ?>">
                                            <source src="<?php echo $feature_5_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($feature_5_itinerary_img); ?>"
                                         alt="The Fly Shop Travel Image">
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_6_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_6_supplemental_img); ?>">
                                            <source src="<?php echo $feature_6_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($feature_6_supplemental_img); ?>"
                                         alt="The Fly Shop Species Image">
                                <?php endif; ?>
                            </div>
                ...
                <!-- Inclusions Tab -->
                <div class="tab-pane fade" id="inclusions-pane" role="tabpanel" aria-labelledby="inclusions-tab">
                ...
                <div id="travel-carousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-indicators">
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image1', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="0"
                                    class="active"
