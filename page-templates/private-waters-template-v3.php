                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_5_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_5_angling_img); ?>">
                                            <source src="<?php echo $feature_5_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($feature_5_angling_img); ?>"
                                         alt="The Fly Shop Travel Image">
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="tab-container-wrapper">
                            ...
                            <div class="feature-image">
                                ...
                                if ($feature_6_video_src) :
                                    ...
                                    <div class="ratio ratio-16x9">
                                        <video class="w-100" controls playsinline preload="metadata"
                                               poster="<?php echo esc_url($feature_6_species_img); ?>">
                                            <source src="<?php echo $feature_6_video_src; ?>" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo esc_url($feature_6_species_img); ?>"
