                    ...
                    <div class="image">
                        ...
                        if (!empty($video_fcfeature_one)) :?>
                            <div class="ratio ratio-16x9 video-poster">
                                <iframe class="w-100" src="<?php echo $video_fcfeature_one; ?>"
                                        allowfullscreen></iframe>
                            </div>
                        <?php else: ?>
                            <img src="<?php echo $feature_fc1_image; ?>" alt="The Fly Shop Fish Camp Image"
                                 class="img-fluid"/>
                        <?php endif; ?>
                    </div>
                </div>
                                    ...
                                    <?php if (!empty($feature_fc1_inclusions_textarea)) : ?>
                                        ...
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span class="travel">Inclusions&nbsp;<span
                                    ...
                                    <?php if (!empty($feature_fc1_noninclusions_textarea)) : ?>
                                        ...
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span class="travel">Non-Inclusions&nbsp;<span
                                                            class="arrow-down"></span></span>
                                            </button>
                                        </h2>
                ...
                <div class="col-md-6">
                    <div class="image">
                        ...
                        if (!empty($video_fcfeature_two)) :?>
                            <div class="ratio ratio-16x9 video-poster">
                                <iframe class="w-100" src="<?php echo $video_fcfeature_two; ?>"
                                        allowfullscreen></iframe>
                            </div>
                        <?php else: ?>
                            <img src="<?php echo $feature_fc2_image; ?>" alt="The Fly Shop Fish Camp Image"
                                 class="img-fluid"/>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="image">
                        ...
                        if (!empty($video_fcfeature_four)) :?>
                            <div class="ratio ratio-16x9 video-poster">
                                <iframe class="w-100" src="<?php echo $video_fcfeature_four; ?>"
                                        allowfullscreen></iframe>
                            </div>
                        <?php else: ?>
                            <img src="<?php echo $feature_fc3_fishing_image; ?>" alt="The Fly Shop Fish Camp Image"
                                 class="img-fluid"/>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="image">
                        ...
                        if (!empty($video_fcfeature_five)) :?>
                            <div class="ratio ratio-16x9 video-poster">
                                <iframe class="w-100" src="<?php echo $video_fcfeature_five; ?>"
                                        allowfullscreen></iframe>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="accordion" id="accordionfive">
                                <div class="accordion-item fishcamp3">
                                    ...
                                    if (!empty($feature_fcfive_readmore_textarea)) :?>
                                        ...
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseOnefive"
                                        ...
                                        <div id="collapseOnefive" class="accordion-collapse collapse"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div id="fishcamp-carousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <!-- Controls -->
                    <button class="carousel-control-prev" type="button" data-bs-target="#fishcamp-carousel"
                            data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#fishcamp-carousel"
                            data-bs-slide="next">
