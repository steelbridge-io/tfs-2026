...
$travel_description           = wpautop(get_post_meta( get_the_ID(), 'travel-description', true ));
$signature_travel_description = wpautop(get_post_meta( get_the_ID(), 'signature-travel-description', true ));
...
$feature_1_readmore               = wpautop(get_post_meta( get_the_ID(), 'feature-1-readmore', true ));
...
$feature_6_species_content  = wpautop(get_post_meta( get_the_ID(), 'feature-6-species-content', true ));
$feature_6_read_more_info   = wpautop(get_post_meta( get_the_ID(), 'feature-6-read-more-info', true ));
$feature_6_species_readmore = wpautop(get_post_meta( get_the_ID(), 'feature-6-species-readmore', true ));
