                            ...
                            <div class="accordion mb-3" id="accordion-seasons-readmore">
                                <?php if (!empty($feature_gs2_seasons_readmore)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseSeasonsmore"
                                                    aria-expanded="false" aria-controls="collapseSeasonsmore">
                                        ...
                                        <div id="collapseSeasonsmore" class="accordion-collapse collapse"
                            ...
                            <div class="accordion" id="accordion2">
                                <?php if (!empty($feature_gs2_spring_textarea)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseEight1"
                                ...
                                <?php if (!empty($feature_gs2_summer_textarea)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseNine1"
                                                    aria-expanded="false" aria-controls="collapseNine1">
                                ...
                                <?php if (!empty($feature_gs2_winter_textarea)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseSeven1"
                                                    aria-expanded="false" aria-controls="collapseSeven1">
                            ...
                            <div class="accordion" id="accordion-fishing-guide-readmore">
                                <?php if (!empty($feature_gs3_fishing_readmore)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseFishing4"
                                                    aria-expanded="false" aria-controls="collapseFishing4">
                                                Read More&nbsp;<span class="arrow-down"></span>
                                        ...
                                        <div id="collapseFishing4" class="accordion-collapse collapse"
                            ...
                            <div class="accordion" id="accordion4">
                                <?php if (!empty($feature_4_gslodging_readmore)) : ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseLodging4"
                                                    aria-expanded="false" aria-controls="collapseLodging4">
                                                Read More&nbsp;<span class="arrow-down"></span>
                                            </button>
                                        </h2>
                                        <div id="collapseLodging4" class="accordion-collapse collapse"
