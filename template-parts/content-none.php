...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'the-fly-shop-2026' ); ?></h1>
	</header><!-- .page-header -->
		...
		if ( is_home() && current_user_can( 'publish_posts' ) ) :
			...
			printf(
				'<p>' . wp_kses(
					...
					__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'the-fly-shop-2026' ),
					array(
						'a' => array(
							'href' => array(),
						),
